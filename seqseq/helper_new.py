...
class CustomHelper(Helper):
  ...
  def __init__(self, initialize_fn, sample_fn, next_inputs_fn, inputs, 
               sequence_length, sampling_probability, time_major=False, seed=None):
    """Initializer.
  ...
  def next_inputs(self, time, outputs, state, sample_ids, name=None):
    with ops.name_scope(
      ...
      def maybe_sample():    
        ...
        sampled_next_inputs = z_mean + tf.random_normal(tf.shape(z_mean))*tf.exp(z_logstd)
